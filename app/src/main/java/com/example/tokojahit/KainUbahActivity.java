...
public class KainUbahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kain_ubah);
        ...
        if (mediaPath == null) {
            ...
            putHerosCall.enqueue(new Callback<PostPutDelKain>() {
                ...
                public void onResponse(Call<PostPutDelKain> call, Response<PostPutDelKain> response) {
                    KainDataActivity.ma.refresh();
                    finish();
                }

                @Override
                public void onFailure(Call<PostPutDelKain> call, Throwable t) {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (isDialogClose) {
                            ...
                            if (ID.trim().isEmpty() == false) {
                                Call<PostPutDelKain> deleteKain = mApiInterface.deleteKain(ID);
                                deleteKain.enqueue(new Callback<PostPutDelKain>() {
                                    @Override
                                    public void onResponse(Call<PostPutDelKain> call, Response<PostPutDelKain> response) {
                                        KainDataActivity.ma.refresh();
                                        finish();
